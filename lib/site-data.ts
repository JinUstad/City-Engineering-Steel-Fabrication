...
export const SERVICES: Product[] = [
  ...
  },
  {
    ...
    features: [
      'RCC Framing, Columns \u0026 Slab Construction',
      'Industrial Epoxy \u0026 Hardener Flooring',
      'Site Fabrication, Erection \u0026 Commissioning',
      'Turnkey Civil \u0026 Structural Project Execution',
    ],
    specs: ['Grade: M25 / M30 RCC Design Mix', 'Flooring: Epoxy Industrial Grade', 'Scope: Turnkey Civil \u0026 Structural'],
  },
]
